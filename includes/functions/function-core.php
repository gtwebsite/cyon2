...
function cyon_header_styles(){
	...
	if($data['primary_font']['face']=='google_font'){
		$primary_font_face = $data['primary_font']['google'];
		$google_fonts[] = $data['primary_font']['google'];
	}else{
	...
	if($data['secondary_font']['face']=='google_font'){
		$secondary_font_face = $data['secondary_font']['google'];
		$google_fonts[] = $data['secondary_font']['google'];
	}else{
	...
	if($data['menu_font']['face']=='google_font'){
		$menu_font_face = $data['menu_font']['google'];
		$google_fonts[] = $data['menu_font']['google'];
	}else{
	...
	if(count($google_fonts)>0){
		...
		foreach($google_fonts as $google_font){
			echo '<link rel="stylesheet" type="text/css" media="all" href="http://fonts.googleapis.com/css?family='.str_replace(' ','+',$google_font).'" />'."\n";
		}
	}
	...
	<style type="text/css">
		body {
			font-family:'<?php echo $primary_font_face; ?>', sans-serif; font-size:<?php echo $data['primary_font']['size']; ?>; font-style:<?php echo $data['primary_font']['style']; ?>; color:<?php echo $data['primary_font']['color']; ?>; background-color:<?php echo $data['background_color'] ?>;<?php echo $background_pattern."\n"; ?>
		}
		h1, h2, h3 {
			font-family:'<?php echo $secondary_font_face; ?>', sans-serif; color:<?php echo $data['secondary_font']['color']; ?>;
		}
		#access ul.menu > li > a, #access_r ul.menu > li > a {
			font-family:'<?php echo $menu_font_face; ?>', sans-serif; font-size:<?php echo $data['menu_font']['size']; ?>; font-style:<?php echo $data['menu_font']['style']; ?>; color:<?php echo $data['menu_font']['color']; ?>;
		}
	</style>	
	<?php echo "\n"; ?>
<?php }
...
function cyon_home_block_bucket(){
	...
	if (is_active_sidebar('home-columns')){
		...
		<div class="block" id="static-block"><div class="block-wrapper<?php echo $class; ?>">
...
function cyon_home_block_static(){
	...
	<div class="block" id="static-block"><div class="block-wrapper">
...
function cyon_home_block_blog(){
	...
	$posts_array = new WP_Query( 'posts_per_page='.$post_per_page );
	$count = 1; $classfirst='';
	...
	if ( $posts_array->have_posts() ) : ?>
		<div class="block" id="blog-block"><div class="block-wrapper<?php echo $data['homepage_blog_layout']>1 ? ' row-fluid' : ''; ?>">
			...
			function checkWidth() {
				...
				if (pagesize <= 768) {
					...
					jQuery('#access_r').click(function(){
						if(jQuery(this).find('ul.menu').width()==0){
							jQuery(this).find('ul.menu').transition({ width: '80%', marginLeft: '0' });
						}else{
							jQuery(this).find('ul.menu').transition({ width: '0', marginLeft: '-50px' });
						}
					});
				}else{
					jQuery('#branding nav').attr('id','access');
					jQuery('#branding nav .menu').attr('style','');
				}
			}
			checkWidth();
