...
function cyon_header_styles(){
	...
	<style type="text/css">
		body {
			font-family:<?php echo $primary_font_face; ?>; font-size:<?php echo $data['primary_font']['size']; ?>; font-style:<?php echo $data['primary_font']['style']; ?>; color:<?php echo $data['primary_font']['color']; ?>; background-color:<?php echo $data['background_color'] ?>;<?php echo $background_pattern."\n"; ?>
		}
		h1, h2, h3 {
