	...
	if(count($team)>0){
		...
		foreach ($team as $member) {
			...
			if($member['email'] || $member['facebook'] || $member['twitter'] || $member['g_plus'] || $member['linkedin']){
				...
				$html .= $member['email']!='' ? '<a href="mailto:'.$member['email'].'" class="hastip" title="Email" target="_blank"><span class="icon-envelope"></span><span class="icon-envelope copy"></span></a>' : '';
