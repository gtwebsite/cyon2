...
//
define( 'ADMIN_PATH', TEMPLATEPATH . '/includes/framework/' );
// define( 'ADMIN_PATH', TEMPLATEPATH . '/admin/' );
define( 'ADMIN_DIR', get_template_directory_uri() . '/includes/framework/' );
// define( 'ADMIN_DIR', get_template_directory_uri() . '/admin/' );
define( 'LAYOUT_PATH', TEMPLATEPATH . '/assets/css/' );
