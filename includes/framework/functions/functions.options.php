...
$of_options[] = array( "name" => "Folding Select",
					"desc" => "Folding Select Box.",
					"id" => "folding_select",
					"std" => "three",
					"type" => "select",
          			"folds" => 1,
...
$of_options[] = array( "name" => "Hidden select 1",
					"desc" => "This is a sample hidden select option 1",
					"id" => "hidden_select_1",
					"std" => "Hi, I\'m just a text input",
          			"fold" => "folding_select_one", /* the select hook */
					"type" => "text");

$of_options[] = array( "name" => "Hidden select 2",
					"desc" => "This is a sample hidden select option 2",
					"id" => "hidden_select_2",
					"std" => "Hi, I\'m just a text input",
          			"fold" => "folding_select_two", /* the select hook */
					"type" => "text");

$of_options[] = array( "name" => "Folding Select 2",
					"desc" => "Folding Select Box.",
					"id" => "folding_select2",
					"std" => "three",
					"type" => "select",
...
$of_options[] = array( "name" => "Hidden select2 1",
					"desc" => "This is a sample hidden select option 1",
					"id" => "hidden_select2_1",
					"std" => "Hi, I\'m just a text input",
          			"fold" => "folding_select2_one", /* the select hook */
					"type" => "text");

$of_options[] = array( "name" => "Hidden select2 2",
					"desc" => "This is a sample hidden select option 2",
					"id" => "hidden_select2_2",
					"std" => "Hi, I\'m just a text input",
          			"fold" => "folding_select2_two", /* the select hook */
					"type" => "text");
...
$of_options[] = array( "name" => "Hidden option 3",
					"desc" => "This is a sample hidden option 2",
					"id" => "hidden_option_2",
					"std" => "Hi, I\'m just a text input",
          			"fold" => "offlines", /* the checkbox hook */
					"type" => "text");
