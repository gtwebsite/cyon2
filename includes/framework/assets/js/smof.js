...
jQuery(document).ready(function($){
	...
	/***** Updated by Gtwebsite *****/
	//(un)fold options in a dropdown-group
	...
	$('#expand_options').click(function(){
		if(flip == 0){
			...
			/***** Updated by Gtwebsite *****/
			$('#of_container #content').addClass('widecontent');
			$('#of_container .group').add('#of_container .group h2').slideDown();
			...
			flip = 0;
			/***** Updated by Gtwebsite *****/
			$('#of_container #of-nav').fadeIn();
			$('#of_container #content').removeClass('widecontent');
